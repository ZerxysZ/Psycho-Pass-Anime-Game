...
user_guess_message = "I'm thinking of a number between 1 and 100. Can you guess it?"
computer_guess_message = "Let's play a game! Think of a number between 1 and 100, and I'll try to guess it."
win_messages = [
    "Congratulations! You guessed the number.",
    "Great job! You got it right!",
    "Wow, you're really good at this game! You guessed it!",
    "Hooray, you win! You guessed the number!"
]
